                ...
                <div className="grid gap-8 mt-12">
                    {skills.map((category, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h3 className="text-xl font-semibold text-white mb-6 pl-4 border-l-4 border-primary">
                                {category.category}
                            </h3>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                                {category.items.map((skill, idx) => (
                                    <motion.div
                                        ...
                                        className="glass-card p-6 flex flex-col items-center justify-center gap-4 text-center group hover:bg-white/10"
                                    >
